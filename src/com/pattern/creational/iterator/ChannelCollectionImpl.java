...
public class ChannelCollectionImpl implements ChannelCollection {
	...
	// this inner class implementation of iterator interface can't be used by any other collection.
	...
	private class ChannelIteratorImpl implements ChannelIterator {
		...
		public boolean hasNext() {
			while(position < channels.size()) {
				...
				if (c.getTYPE().equals(type) || c.getTYPE().equals(ChannelTypeEnum.ALL)) {
					return true;
				} else {
					position ++;
				}
